...
{
    public class IndiaAuthService : AuthServiceBase, IAuthService
    {
        private readonly AuthRegionViewModel _region;
        
        public IndiaAuthService(IAuthRepository repository, ILoggerFactory loggerFactory, IMapper mapper, IWebHostEnvironment environment) : base(repository, loggerFactory, mapper, environment)
        {
