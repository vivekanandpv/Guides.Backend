...
namespace Guides.Backend.Controllers.Uganda
{
    ...
    [Route(EndpointStaticStore.DietaryBehaviourUgandaTemplate)]
    [ApiController]
    public class DietaryBehaviourController : ControllerBase
    {
        private readonly IUgandaDietaryBehaviourService _service;
        private readonly IAppUtils _appUtils;

        public DietaryBehaviourController(IUgandaDietaryBehaviourService service, IAppUtils appUtils)
        {
            _service = service;
            _appUtils = appUtils;
        }
