...
namespace Guides.Backend.Controllers.India
{
    ...
    [Route(EndpointStaticStore.LossToFollowUpIndiaTemplate)]
    [ApiController]
    public class LossToFollowUpController : ControllerBase
    {
        private readonly IIndiaLossToFollowUpService _service;
        private readonly IAppUtils _appUtils;

        public LossToFollowUpController(IIndiaLossToFollowUpService service, IAppUtils appUtils)
        {
            _service = service;
            _appUtils = appUtils;
        }
